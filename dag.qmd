...
coords <- tibble::tribble(
  ...
  , "events", 1, 1
  , "third_party", 3, 1 
  , "financial_situation", 1, 2
  , "problem", 3, 1.5
  , "persistance", 5, 3
  , "stakes", 3, 3
  , "legal_framework", 3, 2.3
  , "problem_resolution", 5, 2
  , "search_mediators",  6, 2
  , "complaint_submission", 7, 2
)

complaining_dag <- dagify(
  complaint_submission ~ search_mediators
  , search_mediators ~  problem_resolution + persistance + third_party
...
:   The consumer is trying to fix a specific thing.
